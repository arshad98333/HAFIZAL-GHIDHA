...
async def main() -> int:
    ...
    ap.add_argument(
        "--wave",
        type=int,
        help="only clear this wave's documents (coverage_state and ledger are NOT touched -- see warning)",
    )
    ...
    async with Logbook(settings, run_id="reset-tool") as book:
        ...
        if args.wave is not None:
            ...
            print(
                "NOTE: coverage_state is a running aggregate across all waves and is NOT reset "
            ...
            print(
                "Full reset: ledger, coverage_state, generation_log, wave_artifacts, decisions, "
