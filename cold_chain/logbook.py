...
# English-only corpus (CURRICULUM.md section 2) -- earlier revisions balanced
# across ar_msa / ar_arabizi / code_switched too; that axis is retired.
LANGUAGES = ["en"]
ARTIFACTS = ["logger_csv", "chat_message", "qc_form_ocr", "voice_note"]
# Replaces the language axis as a balanced covariate: one of the six GCC
# states per record, tying each record to a guardrails/ country overlay and
# a gcc_food_law_json profile. Never an input to rules_engine.label.
JURISDICTIONS = list(kb.JURISDICTIONS)
